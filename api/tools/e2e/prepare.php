...
foreach (['morefoto.access', 'morefoto.commerce', 'morefoto.organization', 'morefoto.media', 'morefoto.handoff', 'morefoto.support', 'rebit.notification', 'rebit.leadhunter'] as $module) {
...
foreach (['rebit.share', 'rebit.auth', 'rebit.notification', 'morefoto.access', 'morefoto.commerce', 'morefoto.organization', 'morefoto.media', 'morefoto.handoff', 'morefoto.support'] as $module) {

...
#[JsonBody]
#[StrictRequest]
final readonly class DeleteGroupPhotosRequestDto implements RequestDtoInterface
{
    /** @param list<mixed> $photoIds элементы проверяет PhotoInputMapper, чтобы вернуть код INVALID_PHOTO_IDS */

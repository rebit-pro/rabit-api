...
#[StrictRequest]
final readonly class DeleteShootRequestDto implements RequestDtoInterface
{
    public function __construct(
        #[RouteParameter(name: 'shoot_id', pattern: InstitutionDetailInputMapper::UUID_PATTERN, errorCode: 'NOT_FOUND', errorStatus: 404)]
        public string $id,

...
/**
 * Меняет забытый пароль по одноразовой ссылке: ссылка гаснет, прежняя сессия завершается и открывается новая.
 * Так посторонний, знавший старый пароль, теряет доступ сразу после сброса.
 */
final readonly class ConfirmPasswordResetUseCase
{
     ...
     */
    public function execute(ConfirmPasswordResetInputDto $input): LoginResultDto
    {

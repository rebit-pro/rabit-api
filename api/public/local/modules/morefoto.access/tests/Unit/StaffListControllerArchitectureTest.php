 ...
 * @internal
 */
final class StaffListControllerArchitectureTest extends TestCase
{
    public function testControllerKeepsTheCleanBoundary(): void
    {
        self::assertSame([], CleanControllerSource::violations(
            dirname(__DIR__, 2) . '/lib/Presentation/Controller/StaffListController.php',
            [
                'Morefoto\Access\Presentation\Controller',
                'Morefoto\Access\Presentation\Staff\StaffListInputMapper',
                'Morefoto\Access\Presentation\Staff\Result\StaffListResultMapper',

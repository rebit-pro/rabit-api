...
/** Содержимое открывается личным ключом в заголовке или короткой подписью из FIL-03 в параметре token. */
#[StrictRequest]
final readonly class DownloadContentRequestDto implements RequestDtoInterface
{

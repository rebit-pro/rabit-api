...
final readonly class OrderTransaction implements OrderTransactionInterface
{
    ...
    public function execute(callable $operation): mixed
    {
        ...
        for ($attempt = 1;; ++$attempt) {
            $started = false;
            try {
                // Quote validation reads a consistent snapshot; an ambient transaction is rejected here.

...
def open_stand(state, args, stand, notification):
    ...
    def serve():
        ...
        # J1: builds ZIP archives; SUPPORT carries the server secret that signs download links.
        service(state, name + "-files", *network, *php, *amqp, *media, *SUPPORT, args.php_cli, "tools/e2e/consume-files.php")

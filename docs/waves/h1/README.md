...
PR будет указан после публикации ветки. Merge и deployment не выполняются автоматически. Деплой объединяется с последующими волнами и выполняется отдельно на `app.morefoto.36.ru` только после согласованного этапа.

...
| B3 | `604d79c` backend, `42b7ec7` frontend и E2E, `b196a78` реестр ACC-07…10/ACC-12 | готово, быстрые проверки |
| U5 | `b3c887f` сводки, `a6953f2` спека и журнал | готово, быстрые проверки |
| U6 | `585f8e3` обзор и виджеты, коммит журнала; попутно `faa8d6d`, `72f27e7` (B4), `b869a00` (U4) | готово, быстрые проверки |
| U7–U8 | — | запланированы в пакете |

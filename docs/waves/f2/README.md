...
- **Развёрнуто 22.09.2026** на `app.morefoto36.ru`, релиз `f2-20260922133013-44f2e36` (main 44f2e36), вместе со слитой E5. Оформление заказов выключено флагом.
  - Откат: `docker service rollback` по сервисам.
  - Прежний backend — релиз E4, прежний frontend — `d3-20260921173000-3bca388`.
  - Дамп БД до миграций проверен восстановлением.
  - Подробности и инцидент первого переключения — progress.

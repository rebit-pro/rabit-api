...
**Схема принята пользователем 11 сентября 2026 года; таблицы и миграции ещё не созданы.** Связано с [моделью](../02-domain/README.md) и [решениями W05](../waves/w05/decisions.md). Каноническая глава БД MoreFoto синхронизируется с принятой основой. UF-поля ниже — проект хранения, не форма API.

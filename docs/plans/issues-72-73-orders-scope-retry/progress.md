...
- Выкладка: 2026-09-25 во frontend-only релизе `guide-20260925125036-7ec736a` вместе с PR #82 (журнал `docs/plans/OPS-stage-run-guide/progress.md`). Следующий шаг: проверка пользователем на stage.

...
- Завершено: U1 (`a144f1e`, `de5a5f0`), U2 (`d7c3661`), draft PR #53; U3 — логотип, аватарки, каркас, меню пользователя, служебные страницы в каркасе, вход, галерея, E2E-селекторы.
- Сейчас: коммит U3.
- Следующий шаг: U4 — поверхности, `MfStatus`, состояния, миграция hex, `@mdi/js`, stylelint; сначала детали волны в плане.
- Блокеры: нет.

...
- Завершено: U1, U2 (`d7c3661`), U3 (`1a944fa`), U4 (`c001fc5`, `eedc437`, `6962cf9`), B4 (`3295ad1`, `92ae90d`, `717136b`, `74011c8`, `f5f2f68`), B3 (`604d79c`, `42b7ec7`, `b196a78`), U5 (`b3c887f` сводки, коммит спеки и журнала), draft PR #53.
- Сейчас: push U5 и обновление описания PR.
- Следующий шаг: U6 — обзор по ролям и виджеты `components/viz/*` (разделы 9.2–9.4 мастер-плана, INF-01/06/08/09/11); сначала детали волны в плане (раздел 4.7): какие сводки U5 и какие экраны обзора берутся, `homePath` → обзор.
...
| DX-U5-01 | PENDING | 2026-09-23 | финальный gate: `zz-summaries.spec.ts` | спека написана, `typecheck:e2e` и ESLint зелёные |
...
- Live-спека `zz-summaries` (финальный gate): у каждой сводки сумма разбивки равна `total`, фильтр не меняет свою разбивку, счётчики куратора не больше, чем у организатора; карточки учреждения и съёмки, фото — по данным предыдущих спек.

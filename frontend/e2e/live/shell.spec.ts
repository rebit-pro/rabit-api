...
const roles = [
  { account: 'organizer', visible: ['Учреждения', 'Ссылки и сроки', 'Списки сотрудников', 'Каталог и цены', 'Сотрудники'], hidden: [] },
  { account: 'curator', visible: ['Учреждения', 'Ссылки и сроки', 'Списки сотрудников'], hidden: ['Каталог и цены', 'Сотрудники'] },
  { account: 'head', visible: ['Учреждения', 'Ссылки и сроки'], hidden: ['Списки сотрудников', 'Каталог и цены'] },
  { account: 'teacher', visible: ['Ссылки и сроки', 'Списки сотрудников'], hidden: ['Учреждения', 'Каталог и цены'] }
] as const;

...
const roles = [
  ...
  },
  {
    ...
    hidden: ['Каталог и цены', 'Сотрудники', 'Вопрос куратору']
  },
  {
    account: 'head',
    visible: ['Обзор', 'Учреждения', 'Ссылки и сроки', 'Списки сотрудников', 'Вопрос куратору'],
    hidden: ['Каталог и цены']
  },
  {
    account: 'teacher',
    visible: ['Мои группы', 'Ссылки и сроки', 'Списки сотрудников', 'Вопрос куратору'],
    hidden: ['Учреждения', 'Каталог и цены']
  }
] as const;
